 ...
 * Simplified SAM-only API - minimal interface for SAM inference.
 *
...
void set_params_sam_fprop(
    Flash_fwd_sam_params &params,
    // Sizes
    const size_t b,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.doc() = "SAM Block Sparse Attention (Inference Only)";
    m.def("fwd_sam", &FLASH_NAMESPACE::mha_varlen_fwd_sam, "SAM forward pass (inference only)");
}

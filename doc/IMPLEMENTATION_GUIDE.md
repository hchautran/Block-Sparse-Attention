...
- [Flash Forward Kernel Explained](./FLASH_FWD_KERNEL_EXPLAINED.md) - **Detailed walkthrough of the attention kernel implementation**
- [Custom Kernel Tutorial](./CUSTOM_KERNEL_TUTORIAL.md) - Step-by-step tutorial for implementing custom block sizes
- [C++ Techniques Guide](./CPP_TECHNIQUES_GUIDE.md) - Explanation of all C++ and CUDA concepts used in the codebase
- [Main README](./README.md) - Project overview and installation instructions

**New to CUDA or C++ Templates?** Start with the [C++ Techniques Guide](./CPP_TECHNIQUES_GUIDE.md) to understand the programming patterns used throughout this codebase.

**Want to understand the kernel implementation?** See [Flash Forward Kernel Explained](./FLASH_FWD_KERNEL_EXPLAINED.md) for a complete walkthrough of the attention algorithm.

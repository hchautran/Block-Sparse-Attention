...
//   - Is_causal (Vision transformers is bidirectional)
//   - Is_local (Vision transformers uses global block-sparse)
//   - Has_alibi (not used in vision)
//   - Is_streaming, Is_exact_streaming (Vision transformers uses block-sparse)

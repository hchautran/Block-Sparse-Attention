...
- [Flash Forward Kernel Explained](./FLASH_FWD_KERNEL_EXPLAINED.md) - Complete walkthrough of the attention kernel
- [Implementation Guide](./IMPLEMENTATION_GUIDE.md) - Detailed implementation documentation
- [C++ Techniques Guide](./CPP_TECHNIQUES_GUIDE.md) - Explanation of all C++ and CUDA concepts used
- [Main README](./README.md) - Project overview and installation instructions

**Note:** If you're unfamiliar with CUDA programming or C++ template metaprogramming, we highly recommend reading the [C++ Techniques Guide](./CPP_TECHNIQUES_GUIDE.md) first. It explains all the advanced C++ features and CUDA concepts used in this codebase.

**Want to understand how attention is computed?** Check out [Flash Forward Kernel Explained](./FLASH_FWD_KERNEL_EXPLAINED.md) for a detailed explanation of the Flash Attention algorithm implementation.
...
- [C++ Techniques Guide](./CPP_TECHNIQUES_GUIDE.md) - **Start here if code is hard to read!**
  - [Template Metaprogramming](./CPP_TECHNIQUES_GUIDE.md#template-metaprogramming)
  - [CUDA Basics](./CPP_TECHNIQUES_GUIDE.md#cuda-basics)
  - [Memory Management](./CPP_TECHNIQUES_GUIDE.md#memory-management)
